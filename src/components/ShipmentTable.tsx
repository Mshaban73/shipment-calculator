                  ...
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-slate-600 w-36">
                    <div className="relative">
                      <input
                        ...
                        className="w-full p-1.5 border border-slate-300 rounded-md text-center shadow-sm focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 transition pr-6"
                      />
